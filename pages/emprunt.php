<?php 
    ...
    $dbh = dbconnect();
                ...
                $sql = "SELECT * FROM membre JOIN emprunt ON membre.id_membre=emprunt.id_membre JOIN livre ON emprunt.id_livre=livre.id_livre WHERE statut=FALSE";
                        ...
                        <div class="col-md-12" >
                            <div class="search__inner">
                                <form action="resultats_recherche_emprunt.php" method="get">
                                    <input placeholder="Recherchez un emprunt ici... " type="text" name="emprunt_r">
                            ...
                            <form action="#">
                                ...
                                <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="product-remove"><a href="../models/rendre_emprunt.php?id_emprunt=<?php echo $row->id_emprunt; ?>">×</a></td>
                                                <td class="product-name"><?php echo $row->prenom_membre; ?></td>
                                                <td class="product-name"><?php echo $row->nom_membre; ?></td>
                                                <td class="product-name"><?php echo $row->intitule_livre; ?></td>
                                                <td class="product-name"><?php echo $row->date_emprunt; ?></td>
                                            </tr>
                                            <?php } ?>
                                            <?php $resultats->closeCursor(); ?>
                                        </tbody>
                                </table>
