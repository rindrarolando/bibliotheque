                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Liste des emprunts en cours...</h2>
            ...
            <div class="container">
                <div class="htc__product__container">
                    ...
                    <div class="row">
                        ...
                        <h1>Configurer un emprunt : </h1>

                            <form action="../models/faire_emprunt.php" method="get">

                                <Label for="membre">Membre</Label>
                                <select name="id_m" id="membre">
                                    <?php foreach($membres as $membre){?>
                                        <option value="<?php echo $membre->getId_membre();?>"><?php echo $membre->getPrenom_membre();?> <?php echo $membre->getNom_membre();?></option>
                                    <?php } ?>

                                </select>
                                <label for="livre">Livre</label>
                                <select name="id_l" id="livre">
                                    <?php foreach($livres as $livre){?>
                                        <option value="<?php echo $livre->getId_livre();?>"><?php echo $livre->getIntitule_livre();?></option>
                                    <?php } ?>
                                </select>

                                <input type="submit" value="SET EMPRUNT">
                            </form>
