<?php 
    ...
    $search = $_GET['membre_r'];

    $membres = array();
    $membres = Membre::search_membre($search);
?>
<!doctype html>
                        ...
                        <div class="col-md-12" >
                            <div class="search__inner">
                                <form action="resultats_recherche_membre.php" method="get" >
                                    <input placeholder="Search here... " type="text" name="membre_r">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Résultats recherche membres</h2>
                                ...
                                <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-price"><span class="amount"><?php echo $membre->getEmail(); ?></span></td>
