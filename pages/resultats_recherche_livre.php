<?php 
    ...
    $livres = array();
    $livres = Livre::search_book($search);
?>
<!doctype html>
                    ...
                    <div class="row" >
                        <div class="col-md-12" >
                            <div class="search__inner">
                                <form action="resultats_recherche_livre.php" method="get" name="livre_r">
                                    <input placeholder="Search here... " type="text" name="livre_r">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Résultats recherche livres</h2>
                                    ...
                                    <div class="product foo">
                                        ...
                                        <div class="product__inner">
                                            <div class="pro__thumb">
                                                <a href="#">
                                                    <img src="<?php echo $livre->getPhoto();?>" alt="product images">
                                                </a>
                                            </div>
                                            <div class="product__hover__info">
                                                ...
                                                <ul>
                                                    <li>
                                                        <a title="Supprimer" href="../models/retirer_livre.php?id=<?php echo $livre->getId_livre(); ?>">
                                        ...
                                        <div class="product__details">
                                            <ul class="product__price">
                                                <li class="new__price"><span style="color: green"><?php echo $livre->getIntitule_livre(); ?></span></li>
                                                <li class="new__price">Auteur:<?php echo $livre->getAuteur_livre(); ?></li>
                                            </ul>
                                        </div>
