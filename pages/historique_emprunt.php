<?php 
    ...
    $sql = "SELECT * FROM membre JOIN emprunt ON membre.id_membre=emprunt.id_membre JOIN livre ON emprunt.id_livre=livre.id_livre WHERE statut=TRUE";
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Historique des emprunts</h2>
                                ...
                                <table>
                                        ...
                                        <?php while($row = $resultats->fetch()) { ?>
                                            <tr>
                                                ...
                                                <td class="product-name"><?php echo $row->date_remise; ?></td>
                                            </tr>
                                            <?php } ?>
